...
class Manche:
    ...
    def __init__(self, Listejoueur, nombredecartes, joueurdebut, log, vies):
        ...
        self.ui.ui.pVies.setText("hey!")
        print(self.ui.ui.pVies.text())
        # self.ui.ui.pVies.update()
        # self.ui.update()
        time.sleep(10)
        # for element in (self.ui.ui.pVies, self.ui.ui.b1Vies, self.ui.ui.b2Vies, self.ui.ui.b3Vies):
        #     element.setText(str(self.vies[0]))
        #     element.update()
        #     print('OK')
        #     print(element.text())
        # self.ui.update()
        ...
        #     (globals)['self.ui.pCarte' + str(i)].setPixmap(QtGui.QPixmap('img/carte.jpg'))
        ...
        while True:
            for nbcartes in range(5, 0, -1):
                ...
                a = Manche(joueurvivant, nbcartes, joueurdebut, self.log,
                           [self.nomJoueurs[k][2] for k in range(len(self.nomJoueurs))])  # crée la manche correspondante
                self.vies = a.vies
