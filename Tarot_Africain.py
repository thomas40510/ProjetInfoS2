...
class Joueur:
    ...
    def choixcartes2(self,dejapresent,paris,pointsterrains,cartesautresjoueurs,indice,nombredecartes,pari,debut):
        if nombredecartes==1:
...
class Manche:
    def __init__(self,Listejoueur,nombredecartes,joueurdebut,aff):
        ...
        for k in range(self.nbjoueurs):
            Listejoueur[k]=Joueur(Lrandomisé[nombredecartes*k:nombredecartes*(k+1)],self.nbjoueurs,Listejoueur[k])
    ...
    def paris(self):
        ...
        for k in range(self.nbjoueurs):
            paris[(k+self.joueurdebut)%self.nbjoueurs]=self.joueurs[(k+self.joueurdebut)%self.nbjoueurs].pari2(paris,self.cartesjoueurs,(k+self.joueurdebut)%self.nbjoueurs)   #pari2!!!!
        if self.aff:
    ...
    def jeu(self):
        ...
        for tour in range(self.nombredecartes):
            ...
            for joueur in range(self.nbjoueurs):
                cartesposées[(joueur+debut)%self.nbjoueurs]=(self.joueurs[(joueur+debut)%self.nbjoueurs].choixcartes2(cartesposées,paris,Points,self.cartesjoueurs,(joueur+debut)%self.nbjoueurs,self.nombredecartes,paris[joueur],debut)) #raisonprécédentbug!!!!
    ...
    def afftour(self,cartesposées,debut):
        if self.nbjoueurs==4:
            return(str(debut)+"\n"+"1:"+str(cartesposées[0])+"  2:" +str(cartesposées[1])+"  3:"+str(cartesposées[2])+"  4:"+str(cartesposées[3]))
